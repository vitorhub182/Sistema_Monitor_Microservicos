...
export class CriaUsuarioDTO {
  @ApiProperty({
    ...
    example: '22eb08fe-bda0-4850-9f05-b7239cce8d7f',
  })
  id: string;
  ...
  @ApiProperty({ description: 'O papel do usuário', example: 'admin' })
  @ValidRole({ message: "Tipo inválido: aceito apenas 'admin' ou 'viewer'" })
