...
export function LogTableComplet({ key, filtros, tempoI, tempoF }: { key: any, filtros: FiltroLogInterface | undefined, tempoI: string | undefined, tempoF: string | undefined }) {
            ...
            <Table>
              ...
              >
                ...
                <SelectContent side="top">
                  {[10, 30, 50, 100, 1000].map((pageSize) => (
